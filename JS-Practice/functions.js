...
// PASS BY VALUE : (All the primitive datatypes are passed by value like number,string and etc.)
// Example : When you give an photo of a book to your friend and if your friend changes that photo then 
//           the photo only changes not the book.
...
// PASS BY REFERENCE : (The object , array, function are passed by reference)
// Example : Imagine you have a box (an object) and you give your friend the box itself. If they change 
//           something inside the box, it affects your box because it’s the same box.
let obj = {
    num : 99,
}
